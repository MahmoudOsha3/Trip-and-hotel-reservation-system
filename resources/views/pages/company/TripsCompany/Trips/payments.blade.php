            ...
            <table class="table table-hover" id="dataTable">
                <thead>
                    <tr>
                        ...
                        <th style="text-align-last: center">@lang('site.trip')</th>
                        <th style="text-align-last: center">@lang('dashboard.trip-date')</th>
                ...
                <tbody>
                    @foreach ($payments as $index => $payment)
                        <tr>
                            ...
                            <td style="text-align-last: center">{{ $payment->ticket->trip->title }}</td>
                            <td style="text-align-last: center">{{ $payment->ticket->trip->date_trip }}</td>
                            <td style="text-align-last: center">{{ $payment->company->title }}</td>
                            <td style="text-align-last: center">{{ $payment->amount }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
