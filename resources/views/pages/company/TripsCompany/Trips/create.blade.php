                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="sub_description[ar]" id="sub_description_ar" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="sub_description[en]" id="sub_description_en"  class="form-control">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <textarea name="description[ar]" id="description_ar" rows="4" class="form-control"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <textarea name="description[en]" id="description_en" rows="4" class="form-control"></textarea>
                        </div>
                    </div>
                </div>
