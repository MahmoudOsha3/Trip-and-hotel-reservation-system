    <!-- Delete Modal -->
    <div class="modal fade" id="delete{{ $owner->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                    ...
                    <div class="modal-body ">
                        <div class="row-auto">
                            <div class="form-group">
                                ...
                                <input type="text" name="id" value="{{ $owner->name }}" readonly class="form-control" id="id"><br>
                            </div>
                        </div>
                    </div>
