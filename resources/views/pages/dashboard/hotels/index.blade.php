...
@section('content')
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                    data-target="#update{{ $hotel->id }}">
                                    <i class="fa fa-edit"></i>
                                    @lang('site.edit')
                                </button>
                                <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                    data-target="#delete{{ $hotel->id }}">
                                    <i class="fa fa-trash"></i>
                                    @lang('site.delete')
                                </button>
                            </td>

                            @include('pages.dashboard.hotels.edit')
                            @include('pages.dashboard.hotels.delete')
                        </tr>
                    @endforeach
                </tbody>
            </table>
    ...
    @include('pages.dashboard.hotels.create')
