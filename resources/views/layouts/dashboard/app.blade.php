...
<head>
    ...
    {{-- <link rel="stylesheet" href="{{asset('dashboard_files/js/chart-init.js')}}"> --}}
    ...
    <link rel="stylesheet" href="{{asset('dashboard/js/chart-init.js')}}">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{ asset('dashboard') }}/index2.html" class="logo">
            ...
            <span class="logo-lg"><b>Med</b>VESTA</span>
        </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                @php $type = Auth::getDefaultDriver() ; @endphp
                                <a href="{{ route('logout' , $type ) }}" class="btn btn-default btn-flat" onclick="event.preventDefault();
